...
<head>
    ...
    <title>Preorder Add Product</title>
...
if ($_SERVER["REQUEST_METHOD"] =="POST" ) 
{
    ...
    if ($count >= 3)
    {
        ...
        $stmt1 = $conn1->prepare("insert into preorder_product  (name, quantity, price, type, vendor_Id) VALUES (?, ?, ?, ?, ?)");
        $stmt1->bind_param("siisi", $pname, $pquantity, $pprice, $ptype, $vendorId);
