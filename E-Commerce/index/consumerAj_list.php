...
<head>
    ...
    <title>View Consumer List</title>
  ...
  function showResult(str) {
    ...
    xhttp.open("GET", "consumer_index.php?searchKey=" + searchKey, true);
    xhttp.send();
  }
            ...
            <div class="col-10">
                ...
                <div >
                    <div >
                        ...
                        <br><center><h2> Consumer List </h2></center><br>
                        
                        <label for="searchKey"><center>Search Email:</center></label>
