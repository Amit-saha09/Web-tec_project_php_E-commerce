...
else
{
    ...
    $stmt1 = $conn1->prepare("select id, name, price, quantity from product where id=?");
...
if ($_SERVER["REQUEST_METHOD"] =="POST" ) 
{
    ...
    {
        $pdiscountERR = "Please Fill Up the Discount";
    }
    else
    {
    ...
    if ($count >= 4)
    {
        $pprice = $pprice - ($pprice * $pdiscount)/100;
        $stmt1 = $conn1->prepare("update product set name=?, price=?, quantity=? where id=?");
            ...
            <div class="col-10">
                ...
                <div class="box">
                    ...
                    Product Name: <input type="text" name="pname"  placeholder="Type Product Name" size="20px" value="<?php echo $pname ?>">
                      ...
                      Disocunt: <input type="number" name="pdiscount"  placeholder="Type Product Discount" size="20px" value="">
                      <p style="color:red"><?php echo $pdiscountERR; ?></p>
                      <br><br>
